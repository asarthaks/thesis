...
Reads results/revision/qualitative_showcase.json (the infill recoveries) and
results/revision/rev_gprime.csv (the on-domain guided pairs), and writes a self-
...
def main():
    ...
    body.append(r"% Auto-generated by revision/make_showcase_tex.py from "
                r"results/revision/qualitative_showcase.json and rev_gprime.csv.")
