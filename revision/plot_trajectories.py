...
def main():
    ...
    ap.add_argument("--npz", default="results/diagnostics/diag/traces_gpt2sft_plot_traj.npz")
    ap.add_argument("--checkpoint", default=CKPT)
    ap.add_argument("--fig_dir", default="figures")
    ap.add_argument("--numbers", default="results/revision/numbers.json")
    args = ap.parse_args()
    ...
    if os.path.exists(args.numbers):
        ...
        anis = {"mean_nearest_neighbour_l2": a.get("mean_nearest_neighbour_l2"),
                ...
                "source": "results/revision/numbers.json:diag_anisotropy_gpt2sft"}
