...
Writes results/revision/gprime_examples.md and results/revision/gprime_examples.tex.
"""
...
GPRIME_CSV = os.path.join(ROOT, "results/revision", "rev_gprime.csv")
PHASE4_CSV = os.path.join(ROOT, "results/revision", "rev_sedd_guided_g4.csv")
...
def main():
    ...
    jpath = os.path.join(ROOT, "results/revision", "gprime_examples.json")
    ...
    print(f"[wrote] {jpath}")
    print(f"[wrote] {os.path.join(ROOT, 'results/revision', 'gprime_examples.md')}")
    print(f"[wrote] {os.path.join(ROOT, 'results/revision', 'gprime_examples.tex')}")
...
def write_markdown(out):
    ...
    path = os.path.join(ROOT, "results/revision", "gprime_examples.md")
...
def write_tex(out):
    ...
    path = os.path.join(ROOT, "results/revision", "gprime_examples.tex")
    with open(path, "w") as f:
        f.write("\n".join(L))
