...
Sources: results/revision/{numbers.json, rev_gprime.json, rev_confusion.json},
...
def main():
    g = load("results/revision/rev_gprime.json")
    c = load("results/revision/rev_confusion.json")
    t = load("figures/fig_traj_stats.json")
    n = load("results/revision/numbers.json")
    all_ok = True
