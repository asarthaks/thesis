...
Usage:
  python revision/analyze_constrained.py \
      --results_dirs results/constrained/main results/constrained/probe \
      --run_name rev_constrained --out_dir results/revision
"""
...
def main():
    ...
    ap.add_argument("--results_dirs", nargs="+", default=["results/constrained/main"])
