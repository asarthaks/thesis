...
Writes results/revision/rev_confusion.json and a staged LaTeX table.
"""
...
def main():
    ...
    ap.add_argument("--csv", default="results/revision/rev_gprime.csv")
    ap.add_argument("--out", default="results/revision/rev_confusion.json")
    ap.add_argument("--tex", default="results/revision/rev_confusion.tex")
