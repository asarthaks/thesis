...
Writes results/revision/qualitative_showcase.json and a LaTeX longtable appendix
...
for p in (ROOT, os.path.join(ROOT, "diagnostics"), os.path.join(ROOT, "scripts")):
...
def main():
    ...
    ap.add_argument("--grid_dir", default="results/grid/gpt2_v2")
