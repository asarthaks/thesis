...
This chapter answers each research question against the evidence of Chapter~\ref{ch:results}, sets out the mechanism the findings share, relates them to the prior work of Chapter~\ref{ch:related}, and states the scope and the implications.

\section{Answers to the Research Questions}
\label{sec:disc-rqs}

Each research question is answered below against the section of Chapter~\ref{ch:results} that establishes the answer.
