...
export HF_HOME=/mount/studenten-temp1/users/singhsk/thesis/thesis/external/hf/cache
export SEDD_REPO=/mount/studenten-temp1/users/singhsk/thesis/thesis/external/Score-Entropy-Discrete-Diffusion
...
LOGDIR=logs/unifiedruns/gprime_slate
mkdir -p "$LOGDIR"
