...
Reads results/constrained/main/*.json and prints the attribution table plus the one
...
Usage:
  python summarize_constrained.py --dir results/constrained/main
"""
...
def main():
    ...
    ap.add_argument("--dir", default="results/constrained/main")
    args = ap.parse_args()
