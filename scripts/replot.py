...
Usage:
  python replot.py --new_dir results_gpt2 --out_dir figures/gpt2
  python replot.py --new_dir results_gpt2 --old_dir Experiments/IdealAlphaSchedule/GradientInformation/results --out_dir figures/gpt2
"""
