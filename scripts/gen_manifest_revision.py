...
Phases follow the plan's own weekly ordering:
  ...
  diagnostics  GPU. GENERATES results/diagnostics/diagnosis (linearization, likelihood_trap,
...
def phase_diagnostics(a, rows):
    # results/diagnostics/diagnosis is empty. Generate the standalone diagnostics that
...
def main():
    ...
    ap.add_argument("--phase", default="all",
                    choices=["all"] + ORDER)
    ap.add_argument("--out_dir", default="results/revision")
    ...
    ap.add_argument("--judge_dir", default="results/revision")
    ap.add_argument("--oracle_dir", default="results/revision")
    ap.add_argument("--seed_dir", default="results/revision")
    ap.add_argument("--diag_dir", default="results/diagnostics/diagnosis",
    ...
    ap.add_argument("--constrained_dirs", nargs="*",
                    default=["results/constrained/main", "results/constrained/probe"],
