...
Usage:
  ...
  python compare_models.py --results_dirs results/grid/gpt2_v2 results/grid/gfn --out_dir figures/compare

  # just the flagship config
  python compare_models.py --results_dirs results/grid/gpt2_v2 results/grid/gfn \
      --out_dir figures/compare --only dls.policy.mh.gn.free.s50
"""
...
def main():
    ...
    ap.add_argument("--out_dir", default="figures/compare")
