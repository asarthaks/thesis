...
Partition the work across your servers with --models and --max_vram:
  ...
  python gen_manifest.py --models gpt2-large --max_vram 24 \
      --n_samples 200 --out_dir results/grid/gpt2_v2 > manifest_gpt2.tsv
  ...
  python gen_manifest.py --models llama3-8b --tier1 --max_vram 48 \
      --n_samples 100 --out_dir results/grid/llama > manifest_llama.tsv
...
def main():
    ...
    ap.add_argument("--out_dir", default="results/grid/rerun")
