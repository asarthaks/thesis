...
SEDD_REPO = os.environ.get(
    "SEDD_REPO",
    "/mount/studenten-temp1/users/singhsk/thesis/thesis/external/Score-Entropy-Discrete-Diffusion")
# route the HF cache to where sedd-small already lives unless the caller overrode it
os.environ.setdefault(
    "HF_HOME",
    "/mount/studenten-temp1/users/singhsk/thesis/thesis/external/hf/cache")
