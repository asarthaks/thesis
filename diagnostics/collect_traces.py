...
mh_log and traj_log simultaneously and neither recorder touches the RNG.
  ...
  python collect_traces.py \
      ...
      --out_dir results/diagnostics/diag \
      --n_seqs 200 --n_traj_seqs 6 --steps 50

Then:
  python analyze_mh.py --csv results/diagnostics/diag/traces_gpt2sft_mh.csv --fig_dir figures
  python plot_diagnostics.py --res_dir results/diagnostics/diag --fig_dir figures
...
def main():
    ...
    ap.add_argument("--out_dir", default="results/diagnostics/diag")
