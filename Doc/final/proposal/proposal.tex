...
% Phase 9 (Part 7 gate): column widths reduced from 6cm/10.5cm (16.5cm, wider than the 15cm
% text block, a 49.9pt overfull) to 4.2cm/9.8cm so the table fits the margins. Content unchanged.
